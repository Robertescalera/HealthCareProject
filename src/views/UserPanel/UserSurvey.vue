          ...
          <v-card>
            ...
            <v-card-text>
              <v-form @submit.prevent="submitSurvey">
                ...
                <v-text-field v-model="survey.age" label="Status" type="number"></v-text-field>
                <v-text-field v-model="survey.sickness" label="Age"></v-text-field>
                <v-text-field v-model="survey.disease" label="Disease"></v-text-field>
                <v-text-field v-model="survey.days" label="How many days?"></v-text-field>
                <!-- You can add more fields for the survey here -->
  ...
  export default {
    data() {
      return {
        ...
        survey: {
          ...
          sickness: '',
          gender: null,
          // Add more fields for the survey as needed
        },
        drawerItems: [
    ...
    methods: {
      ...
      submitSurvey() {
        ...
        // You can access the survey data using this.survey
        console.log('Survey submitted:', this.survey);
        // Perform actions like sending the data to a server or storing it in the Vuex store
      },
    },
  };
  </script>
