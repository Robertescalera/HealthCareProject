...
<html lang="en">
  ...
  <body style="background: #F0F2F0;background: -webkit-linear-gradient(to bottom, #000C40, #F0F2F0);background: linear-gradient(to bottom, #000C40, #F0F2F0); background-size: cover;">
    ...
    <div class="container">
      ...
      <a class="navbar-brand js-scroll-trigger" href="index.php" style="margin-top: 10px;margin-left:-65px;font-family: 'IBM Plex Sans', sans-serif;"><h4><i class="" aria-hidden="true"></i> HEALTH CARE CENTER </h4></a>
    ...
    animation: mover 1s infinite alternate;">
          <icon src="" alt="" style="width: 20%;padding-left: 40px;margin-top: 150px;margin-left: 45px;margin-bottom:15px">
      </div>
      ...
      <div style="color: white;">
         ...
         <div class="col-md-4" style="margin-top: 5%;right: 8%">
          <div class="card" style="font-family: 'IBM Plex Sans', sans-serif;">
            <div class="card-body">
              <center>
                <i class="fa fa-o fa-3x" aria-hidden="true" style="color:#0062cc"></i>
                <br>
              <h3 style="margin-top: 10%">Patient Login</h3><br>
              <form class="form-group" method="POST" action="<?= site_url('login'); ?>">
    ...
    <div class="row">
        <div class="col-md-12">
            <a href="func" class="float-right mt-3" style="border: 1px solid gray; padding: 5px; border-radius: 10px; background-color: white; color: green;; ">Login</a>
        </div>
    </div>
</form>
