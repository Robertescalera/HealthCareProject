...
<html lang="en">
  ...
  <a class="navbar-brand" href="#"><i class="fa fa-o" aria-hidden="true"></i> Health Care Management </a>
...
.btn-primary{
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
     <ul class="navbar-nav mr-auto">
       <li class="nav-item">
        <a class="nav-link" href="/index"><i class="fa fa-power-off" aria-hidden="true"></i> Logout</a>
      </li>
       <li class="nav-item">
